...
function modalItemShareButtonsHtml(itemLink, title) {
    return `<div style="display:inline-block; position: absolute; bottom: 0; left:0; right:0; margin-inline: auto; 
     ...
     <a class="item_share_button"style="background-image: url('static/img/icons/edit.png');" href="${location.origin}/Edit?${encodeURIComponent(itemLink.split('?search=')[1] || '')}"  data-link title="Редактиране!"></a>
