...
async function getItems(itemType, itemsList)  // ItemType = car, caravan, products etc.
{
    ...
    for (let i = 0; i < allItems.length; i++) {
        ...
        combined_items += (`<div class="content_container_item">
         ...
         <a class="item_share_button" style="background-image: url('static/img/icons/edit.png'); margin-top: 20px;" href='javascript:void(0)' onclick="window.location.href='${location.origin}/Edit?${itemLink.split('?search=')[1]}' data-link title="Редактиране!"></a>
